<template>
        ...
        <div class="mx-10 mb-5 min-h-screen">
          <div class="flex items-center justify-between py-5">
            <div class="flex items-center">
              ...
              <h2 class="text-[18px] uppercase leading-none">TOP SẢN PHẨM PHỔ BIẾN </h2>
            </div>
            <div>
  ...
  const columns = [
    ...
    {
      title: 'Số lượng',
      key: 'frequency_of_appearance',
      dataIndex: 'frequency_of_appearance'
    },
  ];
  ...
  const fetchData = async () => {
    ...
    try {
      const { data } = await axios.get('/statistics/popular-products', {
        params: {
          date: date.value,
