<template>
        ...
        <div class="mx-10 mb-5 min-h-screen">
          <div class="flex items-center justify-between py-5">
            <div class="flex items-center">
              ...
              <h2 class="text-[18px] uppercase leading-none">TOP SẢN PHẨM YÊU THÍCH </h2>
            </div>
            <div>
  ...
  const fetchData = async () => {
    ...
    try {
      const { data } = await axios.get('/statistics/products?condition=product_wishlist_top', {
        params: {
          date: date.value,
