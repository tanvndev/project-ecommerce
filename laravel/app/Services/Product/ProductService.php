...
class ProductService extends BaseService implements ProductServiceInterface
{
    ...
    public function deleteMultiple()
    {
        return $this->executeInTransaction(function () {
            ...
            $checkProductLock = $this->productRepository->findProductLock($request->modelIds);
            if ($checkProductLock) {
                return errorResponse('Sản phẩm đã được sử dụng trong các bản ghi của bạn.');
            }
            ...
            $this->productRepository->{$forceDelete}('id', $request->modelIds);
