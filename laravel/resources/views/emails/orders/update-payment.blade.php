...
<body>
    <div class="container">
        <div class="header">
            <h1>Thông báo trạng thái thanh toán</h1>
        </div>

        <div class="greeting">
            <p>Xin chào <strong>{{ $order->customer_name }}</strong>,</p>
            <p>
                Cảm ơn bạn đã mua sắm tại cửa hàng của chúng tôi! Đơn hàng của bạn được xác nhận là
                <strong>{{ $order->payment_status == 'paid' ? 'đã thanh toán' : 'chưa thanh toán' }}</strong>. Dưới đây
                là chi tiết đơn hàng của bạn:
            </p>
        </div>
