...
<body>
    <div class="container">
        <div class="header">
            <h1>Thông báo đơn hàng bị hủy</h1>
        </div>

        <div class="greeting">
            <p>Xin chào <strong>{{ $order->customer_name }}</strong>,</p>
            <p>
                Cảm ơn bạn đã chọn mua sắm tại cửa hàng của chúng tôi! Đơn hàng của bạn vừa xác nhận hủy đơn hàng .
                Dưới đây là chi tiết đơn hàng đã hủy của bạn:
            </p>
        </div>
        ...
        <div class="order-info">
            ...
            <p><strong>Trạng thái đơn hàng:</strong> Đơn hàng đã bị hủy</p>
            <p><strong>Ngày hủy đơn hàng:</strong> {{ formatTimeOrder($order->update_at) }}</p>
